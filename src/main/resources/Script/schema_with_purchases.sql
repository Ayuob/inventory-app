...
----------------------------------------------------------
-- EMPTY THE Inventorys DATABASE IN CASE IT CONTAINS CONTENT
----------------------------------------------------------
...
DROP TABLE IF EXISTS purchase.suppliers;
...
-- Create a table for the Inventorys category data
...
-- Create a table for the Inventorys product data
...
-- Create a table for the Inventorys customer data
...
-- Create a table for the Inventorys order data
...
CREATE TABLE purchase.suppliers (
                                    supplier_id   INT GENERATED ALWAYS AS IDENTITY (START WITH 100 INCREMENT BY 1) NOT NULL PRIMARY KEY,
